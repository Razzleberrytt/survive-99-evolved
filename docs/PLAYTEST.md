...
- Use admin tools only in Studio or whitelisted accounts.
- Verify:
  ...
  - No errors in output for 10 minutes of play

## Commands / Toggles
- `/audit` and `/shipcheck` should surface: StreamingEnabled, remotes count, memory/fps probes.
